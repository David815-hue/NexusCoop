...
class ReportePagoController extends Controller
{
     ...
     */
    public function GetReportePago($COD_REPORTEPAGO)
    {
        $response = Http::get('http://localhost:8080/SEC_REPORTEPAGO/'.$COD_REPORTEPAGO);
        return view('ModuloReportes.Pago.reportePago')->with('ResulReportesPago', json_decode($response,true));
    }
