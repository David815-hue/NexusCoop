...
@section('title', 'Reporte movimiento de cuentas')
...
<div class="container">
    <div class="table-responsive">
        ...
        <form action="{{ route('Generar.store') }}" method="POST">
            ...
            <table id="RepMovCuenta" class="table table-striped table-hover">
                <thead>
                    <tr>
                ...
                <tbody><!--ResulTodosReportesMovCuenta -->
                    @if($ResulTodosRepMovCuenta)
                        @foreach($ResulTodosRepMovCuenta as $movCuenta)
                        <tr>
